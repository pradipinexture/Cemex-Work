...
countryToProcess = "Czech" // Country name from where we need to export the web contents (Cemex 7.0)
...
def handleRepeatableElement(Element element, JSONObject result, String name) {
    ...
    if (type == "selection_break") {
        ...
        element.elements("dynamic-element").eachWithIndex { nestedElement, index ->
            ...
            if (contentElement != null) {
                ...
                if (content != null && !content.isEmpty()) {
                    item.put("${nestedName}_${index + 1}", content)
