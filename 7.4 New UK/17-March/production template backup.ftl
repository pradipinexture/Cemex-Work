      ...
      <div class="row my-5">
        ...
        <div class="col-md-6">
          <div class="containerText">
            ...
            <img alt="${LocationImage.getAttribute("alt")}" style="border-radius: 25px 0 25px 0 !important; max-width: 500px; max-height: 300px; width: 100%; height: 100%;" data-fileentryid="${LocationImage.getAttribute('fileEntryId')}" src="${LocationImage.getData()}&imagePreview=1" class="img-fluid rounded" />   </#if>
          </div>
        </div>
      </div>
    </div>
