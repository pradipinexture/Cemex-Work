...
function isClosedXMlOperations(webContentData, valueForUpdateOfClosed) {
    ...
    const isCSVLocationElement = xmlDocIsCls.querySelector('dynamic-element[field-reference="isCSVLocation"]');

    if (isCSVLocationElement) isCSVLocationElement.remove();
    if (isClosedElement) isClosedElement.remove();
        ...
        const attributes = {
            ...
            'field-reference': isClosedConfig.fieldName,
