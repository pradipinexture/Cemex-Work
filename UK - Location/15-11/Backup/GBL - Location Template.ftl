            ...
            <#if OpeningHours?has_content && OpeningHours.getSiblings()?has_content && OpeningHours.getSiblings()?size != 0>
                ...
                <#list OpeningHours.getSiblings() as cur_OpeningHours>
                    <div class="row">
                        ...
                        <div class="col-6">
                            <#if getterUtil.getBoolean(cur_OpeningHours.isClosed.getData())>Closed
                            <#else><#if (cur_OpeningHours.Open.getData())??>${cur_OpeningHours.Open.getData()}</#if>
                                 - <#if (cur_OpeningHours.Close.getData())??>${cur_OpeningHours.Close.getData()}</#if></#if>
                        </div>
                    </div>
                </#list>
            </#if>
          ...
          <div class="containerText">
            <div class="embed-responsive embed-responsive-16by9">
              <iframe style="min-height:400px; width:100%; border-radius:25px 0 25px 0;"
                referrerpolicy="no-referrer-when-downgrade" src="" allowfullscreen="" loading="lazy"
...
<script>
  ...
  // This conditional flow suggested us James B.
  if (themeDisplay.getLanguageId() === "en_GB" && document.getElementById("location-heading").textContent.toLowerCase().includes('concrete')) {
      ...
      console.log("innter")
      // Set multiple attributes and styles
  ...
  function getReverseGeocodingData(latitude, longitude, callback) {
