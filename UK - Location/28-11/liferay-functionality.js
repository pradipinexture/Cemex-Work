...
async function updateArticle(locationformData, articleId, articleName, articleProductCategories, isCSV, isOpenClose) {
   try {
        var webContent = await getArticle(articleId);
       ...
       if(isCSV) {
            ...
            await addArticle(locationformData, articleName, articleProductCategories);
       } else {
